...
class AppColors {
  static const Color kBackground = Color.fromRGBO(247, 248, 253, 1.0);
  static const Color kPrimary = Color.fromRGBO(10, 70, 129, 1.0);
  static const Color kSecondary = Color.fromRGBO(0, 159, 227, 1.0);
  static const Color kTertiary = Color.fromRGBO(0, 159, 227, 1.0);
  static const Color kButtonPrimary = Color.fromRGBO(255, 191, 0, 1.0);
  static const Color kButtonSecondary = Color.fromRGBO(255, 191, 0, 1.0);
  ...
  static const Color kCardBackground = Color.fromRGBO(255, 255, 255, 1.0);
